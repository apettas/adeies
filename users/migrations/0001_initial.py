        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_employee",
                    models.BooleanField(
                        default=False, verbose_name="Θα γίνει Πιστοποίηση του χρήστη;"
                    ),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, verbose_name="Μεταφερόμενες ημέρες ΚΑΝΟΝΙΚΗΣ άδειας"
                    ),
                ),
                (
                    "carryover_previous_years",
                    models.PositiveIntegerField(
                        default=0,
                        verbose_name="Μεταφερόμενες ημέρες κανονικής προηγούμενων ετών",
                    ),
                ),
                (
                    "carryover_sick_leave",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Μεταφερόμενες αναρρωτικές άδειες"
                    ),
                ),
                (
